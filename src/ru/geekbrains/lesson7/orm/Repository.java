...
public class Repository<T> {
    ...
    public String buildCreateTableStatement() {
        ...
        for (Field fld : clazz.getDeclaredFields()) {
            if (!fld.isAnnotationPresent(geekbrains.lesson7.orm.Field.class)) {
                continue;
            }
            geekbrains.lesson7.orm.Field fldAnnotation = fld.getAnnotation(geekbrains.lesson7.orm.Field.class);
